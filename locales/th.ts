export const th = {
  ...
  common: { viewAll: 'ดูทั้งหมด', updated: 'อัปเดต', live: 'เรียลไทม์', normal: 'ปกติ', warning: 'คำเตือน', offline: 'ออฟไลน์', critical: 'วิกฤต', info: 'ข้อมูล', acknowledged: 'รับทราบแล้ว', needsAttention: 'ต้องตรวจสอบ', language: 'ภาษา', theme: 'ธีม', light: 'สว่าง', dark: 'มืด', english: 'EN', thai: 'TH', save: 'บันทึกการเปลี่ยนแปลง' },
  ...
  temperature: { title: 'อุณหภูมิ', desc: 'ค่าความชื้นและอุณหภูมิแบบเรียลไทม์จากห้องที่เชื่อมต่อ', room: 'ห้อง', temperature: 'อุณหภูมิ', humidity: 'ความชื้น', pm25: 'PM2.5', sensorId: 'รหัสเซนเซอร์', empty: 'ยังไม่พบข้อมูลห้อง ตรวจสอบว่า Node-RED ส่งข้อมูลเข้า Firestore แล้ว' },
